Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/Creolophus/MWPhotoBrowser'
  s.author = { 'Michael Waterfall' => 'civilian0304@gmail.com' }
  s.social_media_url = 'https://twitter.com/mwaterfall'

  s.source = {
    :git => 'https://github.com/Creolophus/MWPhotoBrowser.git',
    :tag => '2.1.2-0.1.2'
  }
  s.platform = :ios, '7.0'
